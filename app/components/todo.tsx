...
export default function Todo(props: any) {
    ...
    return(
        <div key={props.id} className={`mt-8 bg-sky-200 w-100 border-l-4 ${props.status == "COMPLETE" ? 'border-l-green-500' : 'border-l-red-500' } px-4 py-2`}>
            ...
            <button onClick={() => {deleteTodo(props.id)}} className="bg-red-200">Delete</button>
        </div>
    )
}