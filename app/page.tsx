...
import '@/app/marketingpage.module.css';
...
export default function Home() {
  ...
  return (
   <div className="marketing-page h-[80vh] w-100% flex flex-col justify-center items-center">
      ...
      <Link href="/create-todo"><button className="mt-6 bg-pink-600 text-slate-100 p-3 px-4 rounded-full shadow-lg">Let's add a todo</button></Link>
   </div>
  );
}
